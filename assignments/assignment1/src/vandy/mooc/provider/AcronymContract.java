...
class AcronymContract
{
     ...
     * on the device.
     */
    public static final String CONTENT_AUTHORITY = "vandy.mooc.acronym";
     ...
     */
    public static final String PATH_ACRONYM = AcronymEntry.TABLE_NAME;

    /**
     * Inner class that defines the contents of the Acronym table.
     */
    public static final
    class AcronymEntry implements BaseColumns
    {
        /**
         ...
         */
        public static final String TABLE_NAME = "acronym_table";
