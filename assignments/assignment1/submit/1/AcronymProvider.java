 ...
 */
public
class AcronymProvider extends ContentProvider
{
    /**
    ...
    UriMatcher buildUriMatcher()
    {
        ...
        // created.
        matcher.addURI( AcronymContract.CONTENT_AUTHORITY, AcronymContract.PATH_ACRONYM,        ACRONYMS );
        matcher.addURI( AcronymContract.CONTENT_AUTHORITY, AcronymContract.PATH_ACRONYM + "/#", ACRONYM );
        return matcher;
    }
    ...
    String getType( Uri uri )
    {
        ...
        switch ( match )
        {
            case ACRONYMS   : return AcronymContract.AcronymEntry.CONTENT_ITEMS_TYPE;
            case ACRONYM    : return AcronymContract.AcronymEntry.CONTENT_ITEM_TYPE;
    ...
    @Override
    public
    int bulkInsert( Uri uri, ContentValues[] contentValues )
    {
        // Create and/or open a database that will be used for reading
        // and writing. Once opened successfully, the database is
        // cached, so you can call this method every time you need to
        ...
        switch ( sUriMatcher.match( uri ) )
        {
            case ACRONYMS:
                ...
                try
                {
                    ...
                    {
                        final long id = db.insert( AcronymContract.AcronymEntry.TABLE_NAME,
                                                   null,
                                                   cvs );
                  ...
                  String    sortOrder )
    {
        ...
        switch ( sUriMatcher.match( uri ) )
        {
            case ACRONYMS:
                ...
                // into the method.
                //
                retCursor = mOpenHelper.getReadableDatabase().query( AcronymContract.AcronymEntry.TABLE_NAME,
                                                                     projection,
                                                                     selection,
                                                                     selectionArgs,
                                                                     null,
                ...
                String[]        selectionArgs )
    {
        ...
        switch ( sUriMatcher.match( uri ) )
        {
            case ACRONYMS:
                ...
                rowsUpdated = mOpenHelper.getWritableDatabase().update(  AcronymContract.AcronymEntry.TABLE_NAME,
                                                                         values,
                                                                         selection,
                                                                         selectionArgs );
                break;
                ...
                String[]    selectionArgs )
    {
        ...
        switch ( sUriMatcher.match( uri ) )
        {
            case ACRONYMS:
                ...
                rowsDeleted = mOpenHelper.getWritableDatabase().delete(  AcronymContract.AcronymEntry.TABLE_NAME,
                                                                         selection,
                                                                         selectionArgs );
                break;
