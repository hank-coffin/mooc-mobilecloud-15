 ...
 */
public
class DeleteCacheReceiver extends BroadcastReceiver
{
    /**
     ...
     */
    public static
    PendingIntent makeReceiverPendingIntent( Context context )
    {
     ...
     */
    public static
    PendingIntent makeCheckAlarmPendingIntent( Context context )
    {
